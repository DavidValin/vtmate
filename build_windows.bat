...
REM ==========================================================
REM  ENSURE CUDA TOOLKIT IF REQUIRED
REM ==========================================================
if "%WIN_WITH_CUDA%"=="1" (
    where nvcc >nul 2>nul
    if errorlevel 1 (
        echo CUDA not detected. Installing CUDA Toolkit...
        ...
        REM Silent install nvcc + runtime
        "%CUDA_INSTALLER%" -s nvcc_%CUDA_VERSION% cudart_%CUDA_VERSION%
        if errorlevel 1 (
...
set "OPENBLAS_LIB_DIR=%OPENBLAS_DIR%\lib"
